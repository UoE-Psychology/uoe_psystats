...
```{r read in data}
cp_teach_acad<-read.csv('D:/Teaching and Supervision/Psychology/MVwR_1920/Draft lectures/cp_teach_acad.csv', header=T)
```

**Q1a. Use lavaan to specify and estimate a linear regression model to test whether aggressive and non-aggressive conduct problems significantly predict academic performance. How do your results compare to those you obtain using the lm() function?**
...
**Q2a. Now specify a model in which non-aggressive conduct problems have both a direct and indirect effect (via teacher relationships) on academic performance**
...
**Q2b. Now test the hypothesis that non-aggressive conduct problems have both a direct and an indirect effect (via teacher relationships) on academic performance**

A: To test this we need to create a new parameter for the indirect effect and examine its 95% confidence interval.
...
**Q2c. Calculate the total (direct+indirect) effect of non-aggressive conduct problems on academic performance**

A: We can create a new parameter that is the sum of the direct and indirect effect to evaluate the total effect of non-aggressive conduct problems on academic performance.
...
**Q2d. Now visualise the estimated model and its parameters using the semPaths() function**

```{r visualise the model}
library(semPlot) #the semPaths() function is part of the semPaths library
...
**Q3a. Now specify a model in which both aggressive and non-aggressive conduct problems have both direct and indirect effects (via teacher relationships) on academic performance. Include the parameters for the indirect effects**
...
**Q3b. Now estimate the model and test the significance of the indirect effects**
...
**Q3c. Write a brief paragraph reporting on the results of the model estimates in Q3b. Include a Figure or Table to display the parameter estimates**

A:
An example write up might look like:
...
![](D:/Teaching and Supervision/Psychology/MvWR_1920/Draft lectures/Figure 1 for path analysis lab.png)