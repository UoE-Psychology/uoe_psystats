...
Instead of always specifying the mean and the standard deviation of the normal curve, we can work with a **standard normal distribution**. 

<div class="def">
#### Standard normal distribution {-}

A standard normal distribution, denoted $N(0, 1)$, is simply a normal distribution with mean = 0 and sd = 1.
</div>
