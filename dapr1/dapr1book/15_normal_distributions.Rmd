...
3. Probability of observing a value greater than `xu`: `1 - pnorm(xu, mean, sd)`
...
Remember the fact that 99.7% of all values lie between the mean plus or minus 3 standard deviations. For safety we will use 4 times the standard deviation/
