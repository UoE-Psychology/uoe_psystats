...
__Reminder:__ If we are using one variable to help us understand or predict values of another variable, we call the former the _explanatory variable_ and the latter the _response variable_.
</div>
...
recalldata<-
  tibble(
    ...
    recall_confidence = round(finalx[,2],1),
...
+ The sign indicates the direction of association
  ...
  + no linear association ($r \approx 0$) means that knowing the value of one variable does not give you any information about the value of the other variable
