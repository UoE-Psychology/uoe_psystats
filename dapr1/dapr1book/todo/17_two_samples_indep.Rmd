...
+ __explanatory variable__ = __independent variable__ = __predictor variable__   
+ __response variable__ = __dependent variable__ = __outcome variable__  
...
`r msmbstyle::solution_begin(hidden = HIDDEN_SOLS, toggle = TOGGLE)`
A visual display of the five-number summary is given by the boxplot. This is typically a very good visualisation when your data involve a quantitative response variable and a categorical explanatory variable.
...
As the parties in the name condition tend to give significantly higher tips on average ($t$ = `r t_stat %>% round(2)`, $p$-value < .0005), than the no name condition, we can attribute this difference in means to being told the waitress' name as part of the greeting.
