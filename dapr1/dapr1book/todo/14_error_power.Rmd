...
We flip the coin 90 times, and it lands on heads 54 times. 
</div>
...
Is our 54 of 90 coin flips that surprising?<br>
...
<br>
Is 55 out of 90 coin flips *surprising enough*? 
...
We have seen that *if $H_0$ is false*, then the probability of incorrectly failing to reject $H_0$ is $\beta$. Conversely, the probability of *correctly rejecting $H_0$* is $1-\beta$. 
This is also known as the **statistical power** of our test. 
