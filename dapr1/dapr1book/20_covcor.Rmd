...
There was a strong negative correlation between total sleep time and self-reported daytime functioning score ($r(48)$ = `r cor(sleepdtf$TST, sleepdtf$dtf) %>% round(2)`, $p < .001$) in the current sample. As total sleep time increased, levels of self-reported daytime functioning decreased.  
`r msmbstyle::solution_end()`
---
