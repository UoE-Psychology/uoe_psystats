...
Data for a sample of 2000 licensed pets from the city of Seattle, USA, can be found at the following url: []().  __TODO: empty url__
...
The `is.na(weight_kg)` will be TRUE wherever `weight_kg == NA` and FALSE otherwise. __TODO: careful, you can not compare for equality NAs, this is why they have a special function is.na. Something like `weight_kg == NA` will be equal to NA if the value in weight_kg is NA. In other words, NA == NA returns NA.__
...
__TODO: could also use drop_na or na.omit?__
