...
If we perform a one-tailed test of $\mu < \mu_{0}$ on a sample of 6 (so our degrees of freedom is 5), we will reject the null hypothesis ($\mu = \mu_{0}$) if our corresponding $t$-statistic is $\leq -2.015$.  
