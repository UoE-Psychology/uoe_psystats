...
A famous test for ESP involves a set of cards known as Zener cards:
...
- Draw the symbol in a bit of paper __without showing it to anyone__
...
Our question of interest, i.e. if ESP exists, is captured by the alternative hypothesis and contradicts the null one.
We always put the claim of interest for our research in the alternative explanation, rather than the null hypothesis.
