...
We will now compute the null distribution for [Example 1](#example-esp-results) on ESP. One experiment is a sequence of $n = 98$ guesses (i.e. a sequence of S's and F's) and represents one sample. The required steps are:
