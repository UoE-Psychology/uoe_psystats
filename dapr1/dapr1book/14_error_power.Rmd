...
It will hopefully help to think of the statistical power of a test in terms of two distributions and their overlap: 
<br>
...
- Type II error ($\beta$). Failing to reject a null hypothesis that is actually false (false negative).
