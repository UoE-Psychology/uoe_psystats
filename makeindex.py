...
ddesc={'': 'The Department of Psychology at the University of Edinburgh offers 3 Undergraduate Courses in statistics, and 2 postgraduate courses. ',
       'dapr1':'Data Analysis in Psychology using R 1 provides foundations in working with data, probability, hypothesis testing and the use of R statistical programming environment.<br><br>The course is taught based on a mixture of lectures, labs and structured independent learning tasks.<br>In semester 1, lectures cover fundamental principles of describing data and of probability theory. In semester 2, lectures build up to discussion of how we make inferences about our hypotheses in psychology, dealing with probability distributions, sampling and hypothesis testing. The course then introduces simple statistical tests for two variables by way of example.<br><br>In labs, the course introduces the fundamental principles of R programming, with a focus on understanding in a general way how R works, such that these principles can be applied to the use of R for applied data analysis. Students apply this learning to topics such as basic calculation, data management, plotting and use of simple statistical tests.',
       
       'dapr2':'Data Analysis in Psychology using R 2 is the ....',
       'dapr3':'Data Analysis in Psychology using R 3 is the ....',
       
       'usmr':'Univariate Statistics & Methodology in R is a semester long course that is taught using a combination of lab and lecture sessions and is suitable for students following Masters programmes in Psychology and Linguistics. It starts with an introduction to basic statistics and the basics of the R programme, and will give student competence in the standard univariate methodology and analysis using R.<br><br>Design and analysis are taught under a unifying framework which shows a) how research problems and design should inform which statistical method to use and b) that all statistical methods are special cases of a more general model. The course concentrates on research designs and analysis for problems in which there is a single outcome variable and would be taught using the general linear model as a framework to design and analysis.<br><br>Content covered includes: Introduction to the use of statistical methods in research; Introduction to R for statistics; Refresher in inferential statistics including Hypothesis testing, Type I vs. Type II errors, p-values, power, correlation, chi-squares; Linear regression: including diagnostics, transformation, different families of models; Multiple regression: extending linear regression to multiple IVs and including interactions, effects coding; The general linear model (GLM) as an inclusive framework (including ANOVA, ANCOVA, mixed designs)',
       ...
       'dapr1lectures':'Lecture Slides is the ....',
       'dapr2lectures':'Lecture Slides is the ....',
       'dapr3lectures':'Lecture Slides is the ....',
       'usmrlectures':'Lecture Slides is the ....',
       'multivarlectures':'Lecture Slides is the ....'
       }
