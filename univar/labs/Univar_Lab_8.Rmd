...
`r task()`Download the `sharks1` dataset from R, create a new script file, and load in the data using the `load()` function. This will load in a dataframe called `sharks`.  
