...
There is nothing wrong with this approach but it is a little wordy to write and not the fastest when it comes to computation time. The `aaply()` function can be used to achieve the same outcome faster and using less code:
